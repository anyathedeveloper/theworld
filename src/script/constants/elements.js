const NOTHING_FOUND = document.querySelector('.nothingfound');
const PRELOADER = document.querySelector('.preloader');
const CONTENT = document.querySelector('.cards');
const NEWS_CONTAINER = document.querySelector('.cards__container');
const SLIDER_CONTAINER = document.querySelector('.slider__wrapper');
